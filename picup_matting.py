...
def matting(matting_type):
  url_params = {
    "mattingType":matting_type, #Cutout type, 1: Portrait, 2: Object, 3: Portrait, 4: One-click beautification, 6: General cutout. Generally use 6 general matting directly, which has universal effect
    #"crop":"", #Whether to crop to the smallest non-transparent area, false does not crop, true crops, non-required items, no parameters will not crop by default
    #"bgcolor":"" #Fill the background color, the url parameter, add it after the url, the hexadecimal uppercase RGB color, such as FFFFFF, it is not required, and the background color will not be filled if you don’t fill it in
  }
...
def matting2(matting_type):
  url_params = {
    "mattingType": matting_type,  # Cutout type, 1: Portrait, 2: Object, 3: Portrait, 4: One-click beautification, 6: General cutout. Generally use 6 general matting directly, which has universal effect
    #"crop": "false",  # Whether to crop to the smallest non-transparent area, false does not crop, true crops, non-required items, no parameters will not crop by default
    #"bgcolor": ""  # Fill the background color, the url parameter, add it after the url, the hexadecimal uppercase RGB color, such as FFFFFF, it is not required, and the background color will not be filled if you don’t fill it in
  }
  query_str = urllib.parse.urlencode(url_params)
...
def mattingByUrl(matting_type):
  ...
  url_params = {
    "mattingType": matting_type,  # Cutout type, 1: Portrait, 2: Object, 3: Portrait, 4: One-click beautification, 6: General cutout. Generally use 6 general matting directly, which has universal effect
    #"crop": "false",  # Whether to crop to the smallest non-transparent area, false does not crop, true crops, non-required items, no parameters will not crop by default
    #"bgcolor": "FFFFFF",  # Fill the background color, the url parameter, add it after the url, the hexadecimal uppercase RGB color, such as FFFFFF, it is not required, and the background color will not be filled if it is not filled in.
